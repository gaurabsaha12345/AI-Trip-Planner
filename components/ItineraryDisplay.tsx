                ...
                <div className="space-y-8">
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <div className="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden">
                           <img src={`https://picsum.photos/seed/${itinerary.destination.replace(/\s/g, '')}/600/400`} alt={`Map of ${itinerary.destination}`} className="w-full h-full object-cover"/>
                        </div>
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <div style={{ width: '100%', height: 300 }}>
                            <ResponsiveContainer>
                                <PieChart>
                                    <Pie data={costData} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={80} fill="#8884d8" label={({ name, percent }) => `${name} ${(percent * 100).toFixed(0)}%`}>
                     ...
                     <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-6 rounded-2xl text-white text-center shadow-lg">
                        ...
                        <button className="bg-white text-blue-600 font-bold py-2 px-6 rounded-full hover:bg-gray-100 transition-colors w-full">
                            Book Now
                        </button>
                    </div>
                </div>
